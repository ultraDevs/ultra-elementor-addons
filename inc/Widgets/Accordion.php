...
class Accordion extends Widgets_Base
{
    ...
    {
        return __( 'ua-accordion', 'ultra-addons');
    }
    ...
    {
        return __( 'Accordion', 'ultra-addons');
    }
    ...
    protected function ua_register_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Content', 'ultra-addons' ),
            ]
        );
        ...
        $this->add_control(
            self::W_NAME . 'speed',
            [
                'label' => __( 'Speed (ms)', 'ultra-addons' ),
        ...
        $repeater->add_control(
            self::W_NAME . 'title',
            [
                'label' => esc_html__( 'Accordion Title', 'ultra-addons' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Accordion Title', 'ultra-addons' ),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Accordion Content', 'ultra-addons' ),
                'type' => Controls_Manager::WYSIWYG,
                'default' => esc_html__( 'Accordion Content ', 'ultra-addons' ),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        self::W_NAME . 'title' => esc_html__( 'Panel 1', 'ultra-addons' )
                    ],
                    [
                        self::W_NAME . 'title' => esc_html__( 'Panel 2', 'ultra-addons' ),
                    ]
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Styles', 'ultra-addons' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Item Margin Bottom', 'ultra-addons' ),
        ...
        $this->start_controls_section(
            self::W_NAME . 'title',
            [
                'label' => esc_html__( 'Tab Header', 'ultra-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Border Color', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#dddddd',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Tab Content', 'ultra-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Content Background Color', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#f7f7f7',
                'selectors' => [
        ...
        <div class="ua-accordion accordion-<?php echo esc_attr($this->get_id()); ?>" <?php echo 'data-accordion-id="' . esc_attr($this->get_id()) . '"'; ?> data-speed="<?php echo $settings[ self::W_NAME . 'speed']; ?>" <?php echo $this->get_render_attribute_string( 'ua_accordion');?>>
            ...
            foreach ( $settings[ self::W_NAME . 'accordions'] as $key => $accordion ) {
                ...
                <div class="ua-accordion__item" <?php echo $this->get_render_attribute_string( self::W_NAME . 'item');?>>
                    <div class="ua-accordion-header <?php if( $accordion[self::W_NAME . 'default_item'] == 'yes' ) echo 'ua-a-active';?>" <?php echo $this->get_render_attribute_string( self::W_NAME . 'title');?>>
                        <?php echo $accordion[ self::W_NAME . 'title' ];?> 
                        <div class="ua-accordion-icon"><i class="eicon-plus-circle-o"></i></div>
                    </div>
                    <div class="ua-accordion-body__contents" <?php if( $accordion[self::W_NAME . 'default_item'] == 'yes' ) echo 'style="display:block;"';?> <?php echo $this->get_render_attribute_string( self::W_NAME . 'contents');?>>
