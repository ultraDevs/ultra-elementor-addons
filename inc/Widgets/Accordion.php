...
class Accordion extends Widgets_Base
{
    ...
    protected function ua_register_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Content', UA_TD ),
            ]
        );
        ...
        $repeater->add_control(
            self::W_NAME . 'title',
            [
                'label' => esc_html__( 'Accordion Title', UA_TD ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Accordion Title', UA_TD ),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Accordion Content', UA_TD ),
                'type' => Controls_Manager::WYSIWYG,
                'default' => esc_html__( 'Accordion Content ', UA_TD ),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        self::W_NAME . 'title' => esc_html__( 'Panel 1', UA_TD )
                    ],
                    [
                        self::W_NAME . 'title' => esc_html__( 'Panel 2', UA_TD ),
                    ]
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Item Margin Bottom', UA_TD ),
        ...
        $this->start_controls_section(
            self::W_NAME . 'title',
            [
                'label' => esc_html__( 'Tab Header', UA_TD ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Tab Content', UA_TD ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Content Background Color', UA_TD ),
                'type' => Controls_Manager::COLOR,
                'default' => '#f7f7f7',
                'selectors' => [
            ...
            foreach ( $settings[ self::W_NAME . 'accordions'] as $key => $accordion ) {
                ...
                <div class="ua-accordion__item" <?php echo $this->get_render_attribute_string( self::W_NAME . 'item');?>>
                    <div class="ua-accordion-header <?php if( $accordion[self::W_NAME . 'default_item'] == 'yes' ) echo 'ua-a-active';?>" <?php echo $this->get_render_attribute_string( self::W_NAME . 'title');?>>
                        ...
                        <div class="ua-accordion-icon"><i class="fa fa-plus"></i></div>
                    </div>
