...
class TestimonialCarousel extends Widgets_Base
{
    ...
    {
        return __( 'Testimonial Carousel', 'ultra-addons');
    }
    ...
    protected function ua_register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Testimonial Content', 'ultra-addons' ),
                'dynamic' => [
                    'active' => true
                ]
            ]
        ...
        $repeater->add_control(
            't_a_title',
            [
                'label' => __( 'Title', 'ultra-addons' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Title', 'ultra-addons' ),
                'dynamic' => [
                    'active' => true
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        't_conten' => __( 'Testimonial Content 1', 'ultra-addons' ),
                        't_author' => __( 'MH Imon', 'ultra-addons' ),
                        't_a_title' => __( 'ultraDevs', 'ultra-addons' ),
                    ],
                    [
                        't_conten' => __( 'Testimonial Content 2', 'ultra-addons' ),
                        't_author' => __( 'MH Imon', 'ultra-addons' ),
                        't_a_title' => __( 'ultraDevs', 'ultra-addons' ),
                    ],
                    [
                        't_conten' => __( 'Testimonial Content 3', 'ultra-addons' ),
                        't_author' => __( 'MH Imon', 'ultra-addons' ),
                        't_a_title' => __( 'ultraDevs', 'ultra-addons' ),
                    ]
                ],
        ...
        $this->add_control(
            'i_desktop',
            [
                'label' => __( 'Slide Per View ( Desktop) ', 'ultra-addons' ),
        ...
        $this->add_control(
            'i_mobile',
            [
                'label' => __( 'Slide Per View ( Mobile) ', 'ultra-addons' ),
                'type' => Controls_Manager::SELECT,
                'default' => '1',
                'options' => [
                    '1' => 1,
        ...
        $this->add_control(
            'i_tablet',
            [
                'label' => __( 'Slide Per View ( Tablet) ', 'ultra-addons' ),
                'type' => Controls_Manager::SELECT,
                'default' => '2',
                'options' => [
                    '1' => 1,
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'background',
                'label' => esc_html__( 'Background', 'ultra-addons' ),
        ...
        $this->add_control(
            'ta_bg_color',
            [
                'label' => esc_html__( 'Triangle Arrow Background', 'ultra-addons' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Color ( Inactive )', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#6f8ba4',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Color ( Active )', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
        ...
        $this->start_controls_section(
            't_t_footer_style',
            [
                'label' => __( 'Footer Content', 'ultra-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            't_f_name_color',
            [
                'label' => esc_html__( 'Name Color', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#3b566e',
                'selectors' => [
        ...
        $this->add_control(
            't_f_title_color',
            [
                'label' => esc_html__( 'Title Color', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#3b566e',
                'selectors' => [
        ...
        $this->add_responsive_control(
            't_f_avatar_w_',
            [
                'label' => esc_html__( 'Image Width', 'ultra-addons' ),
        ...
        $this->add_responsive_control(
            't_f_avatar_h',
            [
                'label' => esc_html__( 'Image Height', 'ultra-addons' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 100,
