...
class Team_members_carousel extends Widgets_Base
{
    ...
    {
        return __('ua-team-members-carousel', UA_TD);
    }
    ...
    {
        return __( 'Team Members Carousel', UA_TD);
    }
    ...
    public function get_style_depends() {
        return [
            UA_TD . '-style-team-members-carousel',
        ];
    }
    ...
    protected function ua_register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tm_content' => __( 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, illo? ', UA_TD ),
                        'tm_name' => __( 'MH Imon', UA_TD ),
                        'tm_designation' => __( 'Founder', UA_TD ),
                    ],
                    [
                        'tm_content' => __( 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, illo?', UA_TD ),
                        'tm_name' => __( 'Imran Khan', UA_TD ),
                        'tm_designation' => __( 'Support Engineer', UA_TD ),
                    ],
                    [
                        'tm_content' => __( 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, illo?', UA_TD ),
                        'tm_name' => __( 'Sohag SRZ', UA_TD ),
                        'tm_designation' => __( 'Software Engineer', UA_TD ),
                    ]
                ],
        ...
        $this->start_controls_section(
            'slide_settings',
            [
                'label' => __( 'Carousel Settings', UA_TD ),
            ]
        );
        ...
        $this->add_control(
            'tmc_i_spv',
            [
                'label' => __( 'Slides Per View ', UA_TD ),
        ...
        $this->add_control(
            'tmc_i_scroll',
            [
                'label' => __( 'Items to scroll', UA_TD ),
                'type' => Controls_Manager::SELECT,
                'default' => '1',
                'options' => [
                    '1' => 1,
                                ...
                                <div class="ua-t-m <?php echo $settings['tm_style'];?>">
                                    ...
                                    <div class="ua-tm__bottom">
                                        <div class="ua-tm__social"> 
                                            <ul>
                                                <li><a href="<?php echo $teammember['tmc_s_fb']['url'];?>" <?php echo $teammember['tmc_s_fb']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_fb']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fa fa-facebook"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_twitter']['url'];?>" <?php echo $teammember['tmc_s_twitter']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_twitter']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_instagram']['url'];?>" <?php echo $teammember['tmc_s_instagram']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_instagram']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fa fa-instagram"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_linked_in']['url'];?>" <?php echo $teammember['tmc_s_linked_in']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_linked_in']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fa fa-linkedin"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_dribbble']['url'];?>" <?php echo $teammember['tmc_s_dribbble']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_dribbble']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fa fa-dribbble"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <?php 
