...
class TeamMembersCarousel extends Widgets_Base
{
    ...
    {
        return __('ua-team-members-carousel', 'ultra-addons');
    }
    ...
    {
        return __( 'Team Members Carousel', 'ultra-addons');
    }
    ...
    protected function ua_register_controls()
    {
        ...
        $tmc_repeater->add_control(
            'tm_u_link',
            [
                'label' => __( 'Member Info Link', 'ultra-addons' ),
        ...
        $tmc_repeater->add_control(
            'tmc_s_fb',
            [
                'label'       => __( 'Facebook URL', 'ultra-addons' ),
                'type'        => Controls_Manager::URL,
                'default'     => [
        ...
        $tmc_repeater->add_control(
            'tmc_s_twitter',
            [
                'label'       => __( 'Twitter URL', 'ultra-addons' ),
                'type'        => Controls_Manager::URL,
                'default'     => [
        ...
        $tmc_repeater->add_control(
            'tmc_s_instagram',
            [
                'label'       => __( 'Instagram URL', 'ultra-addons' ),
                'type'        => Controls_Manager::URL,
                'default'     => [
        ...
        $tmc_repeater->add_control(
            'tmc_s_linked_in',
            [
                'label'       => __( 'Linkedin URL', 'ultra-addons' ),
                'type'        => Controls_Manager::URL,
                'default'     => [
        ...
        $tmc_repeater->add_control(
            'tmc_s_dribbble',
            [
                'label'       => __( 'Dribbble URL', 'ultra-addons' ),
                'type'        => Controls_Manager::URL,
                'default'     => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tm_content' => __( 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, illo? ', 'ultra-addons' ),
                        'tm_name' => __( 'MH Imon', 'ultra-addons' ),
                        'tm_designation' => __( 'Founder', 'ultra-addons' ),
                    ],
                    [
                        'tm_content' => __( 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, illo?', 'ultra-addons' ),
                        'tm_name' => __( 'Imran Khan', 'ultra-addons' ),
                        'tm_designation' => __( 'Support Engineer', 'ultra-addons' ),
                    ],
                    [
                        'tm_content' => __( 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora, illo?', 'ultra-addons' ),
                        'tm_name' => __( 'Sohag SRZ', 'ultra-addons' ),
                        'tm_designation' => __( 'Software Engineer', 'ultra-addons' ),
                    ]
                ],
        ...
        $this->start_controls_section(
            'slide_settings',
            [
                'label' => __( 'Carousel Settings', 'ultra-addons' ),
            ]
        );
        ...
        $this->add_control(
            'tmc_i_spv',
            [
                'label' => __( 'Slides Per View ', 'ultra-addons' ),
        ...
        $this->add_control(
            'tmc_i_scroll',
            [
                'label' => __( 'Items to scroll', 'ultra-addons' ),
                'type' => Controls_Manager::SELECT,
                'default' => '1',
                'options' => [
                    '1' => 1,
        ...
        $this->add_control(
            'tmc_show_navs',
            [
                'label' => __( 'Show Navs?', 'ultra-addons' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'tmc_show_dots',
            [
                'label' => __( 'Show Dots?', 'ultra-addons' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'tmv_i_autoplay',
            [
                'label' => __( 'Autoplay?', 'ultra-addons' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Autoplay Speed', 'ultra-addons' ),
        ...
        $this->add_control(
            'tmc_item_padding',
            [
                'label' => __( 'Item Spacing', 'ultra-addons' ),
        ...
        $this->start_controls_section(
            'tmc_nav_dot_section',
            [
                'label' => __( 'Navs & Dots', 'ultra-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control( 
            'tmc_nav_bg_c',
            [
                'label' => __( 'Nav Backgorund', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#5820e5',
                'selectors' => [
        ...
        $this->add_control( 
            'tmc_dot_bg_c',
            [
                'label' => __( 'Dot Backgorund', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#5820e5',
                'selectors' => [
        ...
        $this->add_control( 
            'tmc_nav_txt_c',
            [
                'label' => __( 'Nav Arrow Color', 'ultra-addons' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
...
?>
        <style>
            .ua-tm-carousel-c .slick-prev, .slick-next{ display: <?php if ( 'yes' == $settings['tmc_show_navs'] ) { echo 'block';} else{ echo 'none';}?> !important; }
            .ua-tm-carousel-c ul.slick-dots{ display: <?php if ( 'yes' == $settings['tmc_show_dots'] ) { echo 'block';} else{ echo 'none';}?> !important; }
        </style>
        <div class="ua-tm-carousel" id="ua-tm-carousel-<?php echo esc_attr($this->get_id()); ?>" data-slides="<?php echo isset( $settings['tmc_i_spv']) ? $settings['tmc_i_spv'] : 3; ?>" data-scroll="<?php echo isset( $settings['tmc_i_scroll']) ? $settings['tmc_i_scroll'] : 1; ?>" data-autoplay="<?php if( $settings['tmv_i_autoplay'] == true) { echo true; } else{ echo false; } ?>" data-autoplay-speed="<?php echo isset( $settings['tmv_i_autoplay_speed']) ? $settings['tmv_i_autoplay_speed'] : 2000; ?>">
                                ...
                                <div class="ua-t-m <?php echo $settings['tm_style'];?>">
                                    ...
                                    <div class="ua-tm__bottom">
                                        <div class="ua-tm__social"> 
                                            <ul>
                                                <li><a href="<?php echo $teammember['tmc_s_fb']['url'];?>" <?php echo $teammember['tmc_s_fb']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_fb']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fab fa-facebook"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_twitter']['url'];?>" <?php echo $teammember['tmc_s_twitter']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_twitter']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fab fa-twitter"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_instagram']['url'];?>" <?php echo $teammember['tmc_s_instagram']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_instagram']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fab fa-instagram"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_linked_in']['url'];?>" <?php echo $teammember['tmc_s_linked_in']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_linked_in']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fab fa-linkedin"></i></a></li>
                                                <li><a href="<?php echo $teammember['tmc_s_dribbble']['url'];?>" <?php echo $teammember['tmc_s_dribbble']['is_external'] ? ' target="_blank"' : ''; echo $teammember['tmc_s_dribbble']['nofollow'] ? ' rel="nofollow"' : ''; ?> ><i class="fab fa-dribbble"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <?php 
