...
class ImageComparison extends Widgets_Base
{
    ...
    {
        return __('ua-image-comparison', 'ultra-addons');
    }
    ...
    {
        return __( 'Image Comparison', 'ultra-addons');
    }
    ...
    protected function ua_register_controls()
    {
        $this->start_controls_section(
            'content_section',
            [
                'label' => __( 'Images & Label', 'ultra-addons' ),
            ]
        );
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    'before_img',
                    [
                        'label' => __( 'Before', 'ultra-addons' ),
                    ]
                );
                    $this->add_control(
                        'before_image',
                        [
                            'label' => __( 'Image', 'ultra-addons' ),
                    ...
                    $this->add_control(
                        'before_txt',
                        [
                            'label' => esc_html__( 'Label', 'ultra-addons' ),
                            'type' => Controls_Manager::TEXT,
                            'default' => __( 'Before', 'ultra-addons' ),
                            'dynamic' => [
                                'active' => true,
                            ],
                        ]
        ...
        $this->start_controls_section(
            'settings',
            [
                'label' => __( 'Settings', 'ultra-addons' ),
            ]
        );
            ...
            $this->add_control( 
                'v_ratio',
                [
                    'label' => __('Visibility Ratio', 'ultra-addons' ),
            ...
            $this->add_control(
                'orientation',
                [
                    'label' => __( 'Orientation', 'ultra-addons' ),
                    'type'  => Controls_Manager::SELECT,
                    'options' => [
                        'vertical' => __( 'Vertical', 'ultra-addons' ),
                        'horizontal' => __( 'Horizontal', 'ultra-addons' ),
                    ],
                    'default' => 'horizontal'
                ]
            );
            ...
            $this->add_control(
                'hide_overlay',
                [
                    'label' => __( 'Hide Overlay', 'ultra-addons' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __( 'Yes', 'ultra-addons' ),
                    'label_off' => __( 'No', 'ultra-addons' ),
                    'default' => 'no',
                    'return_value' => 'yes',
                ]
            );
            ...
            $this->add_control(
                'handle',
                [
                    'label' => __( 'Move Handle', 'ultra-addons' ),
                    'type'  => Controls_Manager::SELECT,
                    'options' => [
                        'on_swipe' => __( 'On Swipe', 'ultra-addons' ),
                        'on_click' => __( 'On Click', 'ultra-addons' ),
                        'on_hover' => __( 'On Hover', 'ultra-addons' ),
                    ],
                    'default' => 'on_swipe'
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'h_a_color',
                [
                    'label' => esc_html__( 'Icon Color', 'ultra-addons' ),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#ff0000',
                    'selectors' => [
