...
class Dashboard {
    ...
    static $menu = '';
    static $icon = UA_ASSETS . 'images/ua_icon.svg';
    ...
    public static function enqueue_scripts( $hook) {
        ...
        wp_enqueue_style( 'ua-dashboard' , UA_ASSETS . 'admin/css/dashboard.css', '', UA_VERSION );
        wp_enqueue_script( 'ua-dashboard' , UA_ASSETS . 'admin/js/dashboard.js', [ 'jquery' ], UA_VERSION, false );
    }
    ...
    public static function register_menu() {
        self::$menu = add_menu_page( __( 'Dashboard - Ultra Elementor Addons', UA_TD ), __( 'Ultra Addons', UA_TD ), 'manage_options', self::PAGE_SLUG, [ __CLASS__, 'view_main' ], self::$icon , 56 );
        ...
        foreach ( $tabs as $key => $value) {
            ...
            add_submenu_page( self::PAGE_SLUG, sprintf( __( '%s - Ultra Elementor Addons', UA_TD ), $value['title'] ), $value['title'] , 'manage_options' , self::PAGE_SLUG . '#' . $key, [ __CLASS__, 'view_main'] );
        }
    }
    ...
    public static function load_template( $temp ) {
        ...
        $temp_file = UA_DIR_PATH . 'templates/admin/dashboard-' . $temp . '.php';
