...
class Animated_Headlines extends Widgets_Base {
	...
	public function get_name() {
		return __( 'ua-animated-headlines', 'ultra-elementor-addons' );
	}
	...
	public function get_title() {
		return __( 'Animated Headlines', 'ultra-elementor-addons' );
	}
	...
	protected function ua_register_controls() {
		...
		$this->add_control(
			'ua_a_h_title_tag',
			[
				'label'   => __( 'Title HTML Tag', 'ultra-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'First Heading', 'ultra-elementor-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'I Love', 'ultra-elementor-addons' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label'   => __( 'Second Titles', 'ultra-elementor-addons' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'New', 'ultra-elementor-addons' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'ua_a_h_second_heading' => esc_html__( 'PHP', 'ultra-elementor-addons' ),
					],
					[
						'ua_a_h_second_heading' => esc_html__( 'WordPress', 'ultra-elementor-addons' ),
					],
					[
						'ua_a_h_second_heading' => esc_html__( 'Elementor', 'ultra-elementor-addons' ),
					],
					[
						'ua_a_h_second_heading' => esc_html__( 'Ultra Addons', 'ultra-elementor-addons' ),
					],
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style', 'ultra-elementor-addons' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Alignment', 'ultra-elementor-addons' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'flex-start' => [
						'title' => esc_html__( 'Left', 'ultra-elementor-addons' ),
						'icon'  => 'fa fa-align-left',
					],
					'center'     => [
						'title' => esc_html__( 'Center', 'ultra-elementor-addons' ),
						'icon'  => 'fa fa-align-center',
					],
					'flex-end'   => [
						'title' => esc_html__( 'Right', 'ultra-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'rotate-1',
				'options' => [
					'rotate-1'           => esc_html__( 'Rotate 1', 'ultra-elementor-addons' ),
					'letters type'       => esc_html__( 'Typing', 'ultra-elementor-addons' ),
					'loading-bar'        => esc_html__( 'Loading Bar', 'ultra-elementor-addons' ),
					'slide'              => esc_html__( 'Slide', 'ultra-elementor-addons' ),
					'clip is-full-width' => esc_html__( 'Clip', 'ultra-elementor-addons' ),
					'zoom'               => esc_html__( 'Zoom', 'ultra-elementor-addons' ),
					'push'               => esc_html__( 'Push', 'ultra-elementor-addons' ),
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Second Heading', 'ultra-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
