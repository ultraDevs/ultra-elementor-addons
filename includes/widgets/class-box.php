...
class Box extends Widgets_Base {
	...
	public function get_name() {
		return __( 'ua-box', 'ultra-elementor-addons' );
	}
	...
	public function get_title() {
		return __( 'Box', 'ultra-elementor-addons' );
	}
	...
	protected function ua_register_controls() {
		...
		if ( version_compare( ELEMENTOR_VERSION, '2.6.0', '<' ) ) {
			$this->add_control(
				'icon',
				[
					'label'       => esc_html__( 'Box Icon', 'ultra-elementor-addons' ),
		...
		$this->add_control(
			self::W_NAME . 'b_title',
			[
				'label'   => esc_html__( 'Box Title', 'ultra-elementor-addons' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Box Title', 'ultra-elementor-addons' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Box Content', 'ultra-elementor-addons' ),
				'type'    => Controls_Manager::WYSIWYG,
				'default' => __( 'Box Content', 'ultra-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Icon Background Color', 'ultra-elementor-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#f30d55',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Box Icon', 'ultra-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Box Title', 'ultra-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Box Content', 'ultra-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
